    ...
    <>
        <div className='flex flex-wrap md:flex-nowrap  xl:pl-[90px] lg:pl-[40px] sm:pl-5 bg-[#f5e9f0]'>
            <div className=' lg:mt-24 mt-8'>
                <h1 className='xl:w-[59%] lg:w-[75%] sm:w-[89%] text-secondary sm:text-5xl xs:text-4xl font-normal p-2.5'>Advanced Microbiological Media Solutions by Safecare Industries in Abu Dhabi</h1>
                <div className='ml-80 '>
                    <Image
                    src={Vector1}
                    />
                ...
                <div className='mt-11 pl-2.5 pb-36'>
                    <button className='w-[134px] h-12 bg-secondary text-white text-base font-normal'>Enquire now</button>
                    <button className='w-[134px] h-12 border border-secondary text-secondary text-base font-semibold ml-3'>Learn more</button>
                </div>
            </div>
            <div className=''>
                <Image
