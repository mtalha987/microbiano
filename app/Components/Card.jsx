...
const Card = () => {
  ...
  return (
    <>
      <div className=" xl:px-[90px] lg:px-10 px-5 mt-[54px] mb-[145px] flex gap-4 flex-wrap lg:flex-nowrap justify-center  overflow-hidden">
        {cardData.map((info,id)=>(
            <div className=" mt-10 lg:mt-0 w-[407px]">
